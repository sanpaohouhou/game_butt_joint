...
export spring_datasource_url='jdbc:mysql://development.ceezehox1xag.ap-northeast-1.rds.amazonaws.com:3306/game_butt_joint?characterEncoding=UTF-8&useSSL=false&serverTimezone=Asia/Shanghai'
